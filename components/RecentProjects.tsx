        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              <div className=" flex relative items-center  justify-center sm:w-[370px] w-[80vw] overflow-hidden sm:h-[40vh]  h-[30vh] mb-10">
              ...
              <div className=" flex items-center justify-center mt-7  mb-3">
                ...
                <div className=" flex items-center justify-center">
                  <a href={link
                  } className="flex lg:text-xl md:text-xs text-sm text-purple">Check Live Site</a>
